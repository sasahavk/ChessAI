...
df = pd.read_csv('C:/Users/sasaa/OneDrive/Documents/GOLANG/src/MyVault/NOTES/UC-Davis/F25/ECS170/ChessAI/positions_with_features.csv')
...
feature_labels = {"attack_balance": "abal","bishop_outposts": "bop","bishop_pair": "bbp","bishop_sqr_sum": "bss","center_attackers": "catk","connected_pawns": "cpwn","defense_balance": "dbal","doubled_pawns": "dpwn","half_open_king_files": "hogf","isolated_pawns": "ipwn","king_ring_enemy_pressure": "krep","king_sqr_sum": "kss","knight_outposts": "kop","knight_sqr_sum": "kss",
