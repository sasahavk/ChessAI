...
####################################################
# NOTE:  temporary while we wait for minimax       #
# group to push their finished evaluation function #
# because the current old one crashes              #
# this is what they gave me when i asked           #
# if you run main.py, copy paste this into         #
# evaluate.py in the minimax folder                #
####################################################
